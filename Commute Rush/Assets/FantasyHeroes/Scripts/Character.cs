...
namespace Assets.FantasyHeroes.Scripts
{
    ...
    public class Character : MonoBehaviour
    {
        ...
        public Texture2D PrimaryMeleeWeapon;
        public Texture2D SecondaryMeleeWeapon;
        public Texture2D Armor;
        public Texture2D Cloak;
        ...
        public void Start()
        {
            Initialize(); // TODO: This workaround call is required for mobile platforms and WebGL (will be fixed in future releases).
        }
        ...
        public void Initialize()
        {
            ...
            ReplaceSprite(PrimaryMeleeWeaponRenderer, PrimaryMeleeWeapon);
            ReplaceSprite(SecondaryMeleeWeaponRenderer, SecondaryMeleeWeapon);
            ReplaceTexture(BodyRenderers, Body);
            ReplaceTexture(ArmorRenderers, Armor);
            ReplaceSprite(CloakRenderer, Cloak);
